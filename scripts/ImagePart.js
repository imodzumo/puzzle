export default class ImagePart {
    ...
    createDiv() {
        ...
        // div.style.backgroundSize = `url(${this.puzzle.imageSrc})`;
        ...
        div.style.height = `${this.puzzle.height / this.puzzle.dimension}px`;

        // let blockWidth = this.puzzle.width / this.puzzle.dimension;

        // div.onclick = () => {
        //
        //     const currentImagePartIndex = this.puzzle.findPosition(this.index);
        //     const emptyImagePartIndex = this.puzzle.findEmpty();
        //     const {x, y} = this.getXY(currentImagePartIndex);
        //     const {x: emptyX, y: emptyY} = this.getXY(emptyImagePartIndex);
        //     // console.log(x, y);
        ...
        //         }
        //         this.puzzle.swapImageParts(currentImagePartIndex, emptyImagePartIndex, true);
        //     }
        // };
