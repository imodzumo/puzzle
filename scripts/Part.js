export default class Part {
    ...
    createDiv() {
        ...
        div.onclick = () => {
            const currentPartIndex = this.puzzle.findPosition(this.index);
            const emptyPartIndex = this.puzzle.findEmpty();
            const {x, y} = this.getXY(currentPartIndex);
            const {x: emptyX, y: emptyY} = this.getXY(emptyPartIndex);
